...
def maxmin(history_obj, max_player_flag):
    ...
    if max_player_flag:
        ...
        for action in valid_actions:
            ...
            max_val = max(max_val, maxmin(new_history, False))
            board_positions_val_dict[new_history_str] = max_val
        return max_val
    else:
        min_val = math.inf
        valid_actions = history_obj.get_valid_actions()
        for action in valid_actions:
            ...
            new_history.current_player = new_history.get_current_player()
            new_history_str = new_history.get_boards_str()
            min_val = min(min_val, maxmin(new_history, True))
            board_positions_val_dict[new_history_str] = min_val
        return min_val
    # TODO implement
